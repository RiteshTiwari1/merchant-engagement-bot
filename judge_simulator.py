...
# Allow env-var overrides (so the key never has to be committed to disk)
import os as _os
if _os.environ.get("BOT_URL"): BOT_URL = _os.environ["BOT_URL"]
if _os.environ.get("LLM_API_KEY"): LLM_API_KEY = _os.environ["LLM_API_KEY"]
elif _os.environ.get("OPENAI_API_KEY") and LLM_PROVIDER == "openai":
    LLM_API_KEY = _os.environ["OPENAI_API_KEY"]
if _os.environ.get("LLM_PROVIDER"): LLM_PROVIDER = _os.environ["LLM_PROVIDER"]
if _os.environ.get("LLM_MODEL"): LLM_MODEL = _os.environ["LLM_MODEL"]
if _os.environ.get("TEST_SCENARIO"): TEST_SCENARIO = _os.environ["TEST_SCENARIO"]
